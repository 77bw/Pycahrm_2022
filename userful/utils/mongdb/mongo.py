...
class MongoClient( object ):
    ...
    #
    # # conn = pymongo.MongoClient('mongodb://{}:{}@{}:{}/?authSource={}'.format("用户名", "密码", "数据库地址", "端口号", "身份认证所用的库"))
    #
    # def __init__(self, username,password,ip, verify_db,db=None,port="27017"):
    #     """构造函数"""
    #     self.client = pymongo.MongoClient('mongodb://{}:{}@{}:{}/?authSource={}'.format(username,password,ip,port,verify_db))
